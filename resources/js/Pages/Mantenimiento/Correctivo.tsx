...
const Correctivo = () => {
  return (
    <>
      <Head title="Mantenimiento Correctivo" />
      
      <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 fade-in h-full overflow-y-auto flex flex-col">
...
Correctivo.layout = (page: React.ReactNode) => <Layout isContentScrollable={false}>{page}</Layout>
