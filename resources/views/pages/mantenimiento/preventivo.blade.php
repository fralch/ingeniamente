    ...
    <div class="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 fade-in">
        ...
        <div class="mb-10 border-b border-slate-100 pb-8">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-wider mb-4">
                <i class="fa-solid fa-calendar-check"></i> Estrategia Planificada
            </div>
            <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 mb-6 font-heading">Mantenimiento Preventivo</h1>
        ...
        <div class="mb-12">
            <h2 class="text-2xl font-bold text-slate-800 mb-6 flex items-center font-heading">
                <span class="bg-blue-100 text-blue-600 w-8 h-8 rounded-lg flex items-center justify-center text-lg mr-3"><i class="fa-solid fa-clock"></i></span>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-6">
                ...
                <h3 class="font-bold text-slate-800 mb-4 border-l-4 border-blue-500 pl-3">Ecuación de MTBF</h3>
                <p class="text-slate-600 mb-4">El MTBF se puede calcular dividiendo el tiempo total que un equipo o sistema está en funcionamiento sin fallas por el número de fallas que ha experimentado.</p>
                
                <div class="flex flex-wrap justify-center gap-8 py-6 bg-white rounded-xl shadow-sm mb-4">
        ...
        <div class="mb-12">
            ...
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-6">
                ...
                <h3 class="font-bold text-slate-800 mb-4 border-l-4 border-blue-500 pl-3">Ecuación de MTTR</h3>
                <p class="text-slate-600 mb-4">El MTTR se puede calcular dividiendo el tiempo total que se ha utilizado para reparar todos los fallos por el número total de fallos.</p>
        ...
        <div class="mb-12 bg-blue-50 p-6 rounded-2xl border border-blue-100">
            <h3 class="font-bold text-blue-800 mb-3">MTBF y MTTR</h3>
        ...
        <div class="mb-12">
            <h2 class="text-2xl font-bold text-slate-800 mb-6 flex items-center font-heading">
                <span class="bg-blue-100 text-blue-600 w-8 h-8 rounded-lg flex items-center justify-center text-lg mr-3"><i class="fa-solid fa-shield-halved"></i></span>
                Confiabilidad
            </h2>
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-6">
                <ul class="list-disc pl-5 space-y-3 text-slate-600 mb-6">
                ...
                <h3 class="font-bold text-slate-800 mb-4 border-l-4 border-blue-500 pl-3">Ecuación de Confiabilidad</h3>
                <p class="text-slate-600 mb-4">La confiabilidad de un equipo o producto puede ser expresada a través de la expresión:</p>
                ...
                <div class="text-sm text-slate-500 bg-white p-4 rounded-xl border border-slate-100 mb-8">
                    <strong class="block mb-2 text-slate-700">Donde:</strong>
                    <ul class="space-y-1">
                ...
                <div class="space-y-6">
                    <div class="bg-white p-5 rounded-xl border border-slate-200">
                        <h4 class="font-bold text-slate-800 mb-2 text-lg">Sistema en Serie</h4>
                        <p class="text-slate-600 text-sm mb-3">Los sistemas en serie se caracterizan por que el funcionamiento de cada ítem que lo compone depende directamente del funcionamiento del componente que le antecede y precede es decir, si uno de los componentes falla, falla todo el sistema.</p>
                        <p class="text-xs text-slate-400 mb-2">Donde Cf1, Cf2, ..., Cfn son las confiabilidades de cada ítem.</p>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-slate-200">
                        <h4 class="font-bold text-slate-800 mb-2 text-lg">Sistema en Paralelo</h4>
                        <p class="text-slate-600 text-sm mb-3">Según Lourival Tavares: "La confiabilidad final de un conjunto de equipos, será obtenida por la suma de los productos de las confiabilidades de cada ítem por sus capacidades de producción, dividido por la suma de las capacidades de producción de esos ítems".</p>
                        <p class="text-xs text-slate-400 mb-2">Donde Cf1, Cf2, Cfn son las confiabilidades de cada uno de los equipos. Pr1, Pr2, ..., Prn son las participaciones de cada uno de los equipos en la producción del sistema evaluado.</p>
                        <div class="flex justify-center py-2">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-slate-200">
                        <h4 class="font-bold text-slate-800 mb-2 text-lg">Sistema Redundante</h4>
                        <p class="text-slate-600 text-sm mb-3">Un sistema redundante se puede definir como: "Cualquier elemento que tenga por un período el 100% de confiabilidad hace '1' a toda la ecuación. Ocurrida la falla, si la conmutación es inmediata, la confiabilidad se mantendrá en el 100% hasta la siguiente falta de este elemento".</p>
                        <p class="text-xs text-slate-400 mb-2">Donde Cf1, Cf2, ..., Cfn son las confiabilidades de cada uno de los equipos.</p>
                        <div class="flex justify-center py-2">
        ...
        <div class="mb-12">
            <h2 class="text-2xl font-bold text-slate-800 mb-6 flex items-center font-heading">
                <span class="bg-blue-100 text-blue-600 w-8 h-8 rounded-lg flex items-center justify-center text-lg mr-3"><i class="fa-solid fa-check-to-slot"></i></span>
                Disponibilidad
            </h2>
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-6">
                <ul class="list-disc pl-5 space-y-3 text-slate-600 mb-6">
                ...
                <p class="text-slate-600 mb-4">La disponibilidad de un equipo puede ser expresada a través de la expresión:</p>
        ...
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-slate-800 mb-6 flex items-center font-heading">
                <span class="bg-blue-100 text-blue-600 w-8 h-8 rounded-lg flex items-center justify-center text-lg mr-3"><i class="fa-solid fa-tools"></i></span>
                Mantenibilidad
            </h2>
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-6">
                <ul class="list-disc pl-5 space-y-3 text-slate-600 mb-6">
                ...
                <h3 class="font-bold text-slate-800 mb-4 border-l-4 border-blue-500 pl-3">Ecuación de la Mantenibilidad</h3>
                <p class="text-slate-600 mb-4">La mantenibilidad de un equipo puede ser expresada a través de la expresión:</p>
