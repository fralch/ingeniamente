    ...
    return (
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 fade-in">
            ...
            <div className="mb-10 border-b border-slate-100 pb-8">
                ...
                {/* Imagen con fade-in */}
                <figure className="relative w-full h-auto rounded-2xl overflow-hidden bg-slate-200" id="img-wrapper">
                    <img
                        src="/asset/poleas.jpg"
                        alt="Conjunto de poleas metálicas en un sistema de grúa industrial"
                        className={`w-full h-auto object-contain transition-opacity duration-700 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'}`}
                ...
                <div>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 h-full">
                        ...
                        <ul className="space-y-3 text-slate-600">
                            ...
                            <li className="flex items-center"><i className="fa-solid fa-check text-emerald-500 mr-3 text-xs"></i> <span>Ascensores</span></li>
                            <li className="flex items-center"><i class="fa-solid fa-check text-emerald-500 mr-3 text-xs"></i> <span>Sistemas de transmisión industrial</span></li>
                        </ul>
                    </div>
                </div>
